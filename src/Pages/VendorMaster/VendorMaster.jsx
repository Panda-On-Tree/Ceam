...
function VendorMaster() {
         ...
         customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
               <div style={{"cursor":"not-allowed"}} >
                <SlTag style={{"pointerEvents":"none", "cursor":"not-allowed"}} variant='warning' size="small" className="tag-row" onClick={e => {
    ...
    function sendVendorData(){
        ...
        axios({
            method: 'post',
            url: `${baseurl.base_url}/mhere/upload-ceam-vendor-master`,
            headers: {
              'Content-Type': 'application/json',
            },
            data:sendVendor
    ...
    function deleteVendor(id){
        ...
        axios({
            method: 'post',
            url: `${baseurl.base_url}/mhere/delete-ceam-vendor-master`,
            headers: {
              'Content-Type': 'application/json',
            },
  ...
  return (
    <div className='vendor-master-main'>
        ...
        <SlDialog  label="Add Employee" open={openAddEmp} onSlRequestClose={() => setOpenAddEmp(false)}>
            ...
            <SlInput className='add-vendor-input' placeholder='eg : VENDOR001' label="Vendor Code" onSlChange={(e)=>{setSendVendor({...sendVendor,vendor_code:e.target.value})}} />
            <SlInput className='add-vendor-input' placeholder='eg : Balaji' label="Vendor Name" onSlChange={(e)=>{setSendVendor({...sendVendor,vendor_name:e.target.value})}}  />
            <SlSelect label="Plant Name"  onSlChange={(e)=>{setSendVendor({...sendVendor,plant_name:e.target.value})}}>
